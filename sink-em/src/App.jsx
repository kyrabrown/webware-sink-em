...
function App() {
    ...
    useEffect(() => {
        ...
        ws.current = new WebSocket("/ws?id=68e1cfadaeb428a6b01dcc88");
        ...
        ws.current.onopen = () => {
            ...
            ws.current.onmessage = async msgSent => {
                ...
                if (type === "Waiting") {
                    ...
                    setUserMessage("Your opponent has disconnected. The game has been reset. Reload to restart this game with the same ID.")
